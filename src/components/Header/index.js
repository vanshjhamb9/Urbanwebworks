...
const Header = () => {
  ...
  return (
    <Headers className="bg-transparent z-100 " ref={ref}>
      <Logo className="items-baseline">
        <img src={logo} alt="webworks" />
        <div className="flex flex-col -space-y-1.5 items-start items-baseline">
        <h3 className="font-bold flex flex-row text-[#00FEFB] gap-2 font-intern text-[1.8rem]"><p>URBAN</p> <p>WEBWORKS</p> </h3>
        <p className="font-ginger text-[1rem] ml-1">TECHNOLOGY</p>
        </div>
      </Logo>
      <Nav className="font-bold flex flex-row items-center justify-between gap-10" >
        ...
        <a href="#expertise" onClick={(e) => scrollUp("home", e)}>
          Our Expertise
        </a>
      ...
      <MobileMenu clicked={+click}>
        ...
        <a href="#expertise" onClick={(e) => scrollUp("expertise", e)}>
          Our Expertise
        </a>
